...
public class SCDKPSPublicSoap
{
    ...
    public SCDKPSPublicSoap(){}

    public SCDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SCDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SCDExtendedSoapSerializationEnvelope envelope= new SCDExtendedSoapSerializationEnvelope(SCDExtendedSoapSerializationEnvelope.VER11);
