...
public class SCDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SCDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SCDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SCDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SCDDateTimeConverter dateTimeConverter = new SCDStandardDateTimeConverter();

    public SCDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SCDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SCDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SCDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SCDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SCDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
